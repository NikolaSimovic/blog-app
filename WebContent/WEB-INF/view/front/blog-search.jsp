              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author?id=${blogs[0].user.id}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="comments meta-last"><i class="icon-comment"></i>${blogs[0].comments.size()}</div>
                  </footer>
                </div>
              </div>
              <!-- post             -->
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author?id=${blogs[1].user.id}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="comments meta-last"><i class="icon-comment"></i>${blogs[1].comments.size()}</div>
                  </footer>
                </div>
              </div>
              <!-- post             -->
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author?id=${blogs[2].user.id}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="comments meta-last"><i class="icon-comment"></i>${blogs[2].comments.size()}</div>
                  </footer>
                </div>
              </div>
              <!-- post -->
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author?id=${blogs[3].user.id}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="comments meta-last"><i class="icon-comment"></i>${blogs[3].comments.size()}</div>
                  </footer>
                </div>
              </div>
            </div>
